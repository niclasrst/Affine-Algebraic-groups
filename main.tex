...
\begin{document}
    ...
    \begin{bemerkung}\label{bem:2}
        ...
        von der Kategorie \(\mathcal{C}\) in die Funktorkategorie \(\mathcal{C}^\vee = \text{Fun}(\mathcal{C}, \textbf{Set})\) kontravariant und volltreu ist. % Morphismen in C^\vee sind genau Nat. Trafos!!
    \end{bemerkung}
    ...
    \begin{definition}
        \begin{enumerate}
            ...
            \item Zu einer \(k\)-Algebra \(A \in \Ob(k\textbf{-Alg})\) betrachte den Funktor
    ...
    \begin{bemerkung}
        ...
        Nach \Cref{def:darstellbar} wird dieser durch die \(k\)-Algebra \(A\) dargestellt, da nach obigem gilt: \(V_{(\;\cdot\;)}(I) \cong h^A\).
    ...
    \begin{bemerkung}
        ...
        Da der Funktor \(A \mapsto h^A\) volltreu ist nach \Cref{bem:2}, folgt die Eindeutigkeit aus folgendem allgemeineren Resultat.
    \end{bemerkung}
    ...
    \begin{definition}
        ...
        \end{gather*}
        Nach \Cref{kor:1} induzieren diese Co-Morphismen auf der \(k\)-Algebra \(k[\mathcal{G}]\)
        \begin{gather*}
        ...
        \begin{enumerate}
            \item Betrachte die additive algebraische Gruppe \(\mathcal{G} = \mathbb{G}_a : R \longrightarrow (R, +)\) mit darstellender Algebra \(k[\mathbb{G}_a] \cong k[X]\) dem Polynomring in einer Variablen.
                ...
                \begin{figure*}[ht!]
                    \centering
                    \begin{tikzcd}
                        {\Hom_{k\textbf{-Alg}}(k[X \otimes 1, 1 \otimes X], R)} \arrow[d] \arrow[r, "\mu_R"] & {\Hom_{k\textbf{-Alg}}(k[X], R)} \arrow[d] \\[2.25em]
    ...
    \begin{lemma}\label{lem:1}
        ...
        \begin{figure*}[ht!]
            ...
            \begin{tikzcd}
                ...
                G \arrow[rr, Rightarrow, no head]                           &  & G                          
